...
const LinkType = PropTypes__default["default"].shape({
...
const PortAlignment = PropTypes__default["default"].oneOf(['right', 'left', 'top', 'bottom']);
const PortType = PropTypes__default["default"].shape({
  id: PropTypes__default["default"].string.isRequired,
  canLink: PropTypes__default["default"].func,
  alignment: PortAlignment
});
const NodeType = PropTypes__default["default"].shape({
  id: PropTypes__default["default"].string.isRequired,
...
const SchemaType = PropTypes__default["default"].shape({
